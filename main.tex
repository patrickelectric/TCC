...
\textAbstract{The world of software development for embedded systems is constantly evolving and adapting to the new technologies that arise to supply the needs of IoT, IoSM and IoIT. Standards are being redefined as much as technologies as the existing development methodology, causing industries to adhere to unorthodox approaches perfoming tasks of high complexity. The objective of this work is the development of a tool capable of allowing the software developer for embedded systems the ability to create, improve and verify their work without the need for proprietary and other limiting tools. The work in addition to reporting the development of such a tool, elaborates the context of the updates that are being carried out within the development market of large companies, in order to accomplish this complex task that is the development of embedded systems in such a heterogeneous and non-standardized market.}
